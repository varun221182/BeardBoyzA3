...
public class UnittestingCarsensor3 {
    public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					//Invoke Carsensor Constructor
					CarSensor eos = new CarSensor("Entry Outside Sensor", 20, 100);
                    //Invoking carIsdetected
					System.out.println("Cardetected Status");
                    System.out.println(eos.carIsDetected());
					} 
				catch (Exception e) {
					e.printStackTrace();
				}
